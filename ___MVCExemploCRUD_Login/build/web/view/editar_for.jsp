                ...
                <div class="panel-body">
                    <form name="form_mvc" class="form-horizontal" action="ControleFornecedor" method="post">
                        <%
                             ...
                             * Controle
                             */
                            List<Fornecedor> forne = (ArrayList) request.getAttribute("listaFornecedors");
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputNome" name="nome" placeholder="Digite seu nome" value="<%=f.getNome()%>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputTelefone" class="col-lg-2 control-label">Telefone</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputTelefone" name="telefone" placeholder="Digite seu telefone" value="<%=f.getTelefone()%>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputValor" class="col-lg-2 control-label">Valor Última Compra</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputValor" name="valor" value="<%=f.getValorUltimaCompra()%>" >
                                </div>
                            </div>
                            <div class="form-group">
