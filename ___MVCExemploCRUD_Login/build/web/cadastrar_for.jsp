                    ...
                    <form name="form_mvc" class="form-horizontal" action="ControleFornecedor" method="post">
                        <fieldset>
                            <div class="form-group">
                                <label for="inputNome" class="col-lg-2 control-label">Nome do Fornecedor</label>
                                <div class="col-lg-10">
                            ...
                            <div class="form-group">
                                <label for="inputValor" class="col-lg-2 control-label">Valor �ltima Compra</label>
                                <div class="col-lg-10">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-2">
                                    <button type="submit" name="acao" class="btn btn-primary" value="cadastrar_for">Cadastrar</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>        
