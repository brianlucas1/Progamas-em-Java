                ...
                <div class="panel panel-primary">
                    <div class="panel-heading" style="height: 50px;">                        
                        <div style="float: left;" >
                            <h3 class="panel-title h1">Fornecedores Cadastrados</h3>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>                     
                                <%
                                     ...
                                     * servlet Controle
                                     */
                                    List<Fornecedor> Fornece = (ArrayList) request.getAttribute("listaFornecedors");

                                    // Percorre a lista dos registros e apresenta no navegador
                                    for (Fornecedor f : Fornece) {
                                %>
                                ...
                                <tr>
                                    ...
                                    <td><span class="glyphicon glyphicon-lock"></span></td>
                                        <%} else {%>
                                    <td><a href="ControleFornecedor?acao=editar_for&id=<%=f.getId()%>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp;Editar</a></td>
                                    <td><a href="ControleFornecedor?acao=excluir_for&id=<%=f.getId()%>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;Excluir</a></td>
                                    <%}%>
                                </tr>
                                <%
